...
@Keep
public class BoardCopy extends BaseModel {

    private String boardId;            // 게시판 코드 (공지사항: B0001)
    @SerializedName("key") private Long postingId;            // 게시글 번호
    @SerializedName("postingTitle") private String postingTitle;       // 게시글 제목
    @SerializedName("postingContent") private String postingContent;     // 게시글 내용
